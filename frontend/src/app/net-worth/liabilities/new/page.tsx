...
import { createLiability } from '@/lib/net-worth-api';
...
export default function NewLiabilityPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Failed to create liability');
      setLoading(false);
    }
  };
  ...
  return (
    <DashboardLayout>
      <div className="max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold mb-6">Add New Liability</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6">
          ...
          <div className="flex gap-3 mt-6">
            ...
            >
              {loading ? 'Creating...' : 'Create Liability'}
            </button>
            <button
              type="button"
              onClick={() => router.back()}
