        ...
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-8">
            ...
            <div className="flex gap-4">
              ...
              <Link href="/transactions" className="text-neutral-700 hover:text-brand-500">
                Transactions
              </Link>
              <Link href="/sinking-funds" className="text-neutral-700 hover:text-brand-500">
                Sinking Funds
              </Link>
              <Link href="/paychecks" className="text-neutral-700 hover:text-brand-500">
                Paychecks
              </Link>
              <Link href="/financial-roadmap" className="text-neutral-700 hover:text-brand-500">
                Roadmap
              </Link>
            </div>
          </div>
